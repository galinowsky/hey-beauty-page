...
export const ui = {
  pl: {
    ...
    "about.teamLabel": "Nasz zespół",
    "about.teamTitle": "Top Specjalistki",
    "about.bookStylist": "Umów wizytę",
  ...
  en: {
    ...
    "about.teamTitle": "Top Specialists",
    "about.bookStylist": "Book appointment",
  ...
  uk: {
    ...
    "about.teamLabel": "Наша команда",
    "about.teamTitle": "Топ спеціалістки",
    "about.bookStylist": "Записатися",
